         ...
         <td><table border="0" cellspacing="0" cellpadding="0">
           <tr>
             ...
             <td><table border="0" cellpadding="5" cellspacing="0" <?php if($_REQUEST['list_for']=="get") echo "bgcolor=\"#FFFFFF\""; ?>>
               <tr>
                 <td><div align="center"><?php if($_REQUEST['list_for']=="get") echo "收到的留言";  else echo "<a href=\"?list_for=get\">收到的留言</a>" ?></div></td>
               </tr>
             </table></td>
             <td width="20">&nbsp;</td>
             <td><table border="0" cellpadding="5" cellspacing="0" <?php if($_REQUEST['list_for']=="sent") echo "bgcolor=\"#FFFFFF\""; ?>>
               <tr>
                 <td><div align="center"><?php if($_REQUEST['list_for']=="sent") echo "发出的留言";  else echo "<a href=\"?list_for=sent\">发出的留言</a>" ?></div></td>
               </tr>
             </table></td>
           </tr>
         </table></td>
      ...
      <tr>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="3">
		  ...
		  <tr>
            ...
            <td><a href="guestbook_view.php?infor_id=<?=$row->id?>&list_for=get" target="_blank" style="text-decoration:underline "><?=$row->infor_title==""?"无标题":$row->infor_title?></a></td>
            ...
            <td><div align="center"><?php  if($row->whisper=="1") echo "纸条"; else echo "留言"; ?></div></td>
			<td><div align="center">
              <?php 
			 if($row->replied) echo "<img src=\"image/mail_replyed.gif\" width=\"14\" height=\"10\" alt=\"已回复\">"; 
			 elseif($row->checked) echo "<img src=\"image/mail_open.gif\" width=\"14\" height=\"10\" alt=\"已读\">"; 
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="3">
         ...
         <?php for($i=1;$i<=$per_page_num;$i++)
		  ...
		  <tr>
            ...
            <td><a href="guestbook_view.php?infor_id=<?=$row->id?>&list_for=sent" target="_blank" style="text-decoration:underline "><?=$row->infor_title==""?"无标题":$row->infor_title?></a></td>
