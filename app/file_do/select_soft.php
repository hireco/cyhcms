...
if(empty($file_class)) $file_class="all";
if($file_class=="soft")  $upload_child_dir=$cfg_soft_root;
else $upload_child_dir=$cfg_doc_root;
...
if($file!="." && $file!=".." && !is_dir("$inpath/$file")){
 ...
 else if($file == "..")
 {
    ...
    $line = "\n<tr>
    <td class='linerow'> <a href='select_soft.php?f=$f&activepath=".urlencode($tmp)."'><img src=image/dir2.gif border=0 width=16 height=16 align=absmiddle>上级目录</a></td>
...
else if(is_dir("$inpath/$file"))
{
   ...
   <td bgcolor='#F9FBF0' class='linerow'>
    <a href=select_soft.php?f=$f&activepath=".urlencode("$activepath/$file")."><img src=image/dir.gif border=0 width=16 height=16 align=absmiddle>$file</a>
   </td>
   <td class='linerow'>-</td>
   ...
   <td class='linerow' bgcolor='#F9FBF0'>
     <a href=\"javascript:ReturnValue('$reurl');\" $lstyle><img src=image/zip.gif border=0 width=16 height=16 align=absmiddle>$file</a>
   </td>
   ...
   $line = "\n<tr>
   <td class='linerow' bgcolor='#F9FBF0'>
     <a href=\"javascript:ReturnValue('$reurl');\" $lstyle><img src=image/exe.gif border=0 width=16 height=16 align=absmiddle>$file</a>
   </td>
   <td class='linerow'>$filesize KB</td>
   <td align='center' class='linerow' bgcolor='#F9FBF0'>$filetime</td>
   </tr>";
...
<input type='hidden' name='file_class' value='<?php echo $file_class?>'>
