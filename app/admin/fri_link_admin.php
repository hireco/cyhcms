  ...
  <tr>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><div align="left">链接标题或者图片</div></td>
		<td><div align="center">链接目标</div></td>
		<td><div align="left">链接名称</div></td>
		<td><div align="left">详细介绍</div></td>
	   ...
	   <tr bgcolor="#FFFFFF" >
		...
		<td><div align="center"><a href="<?=$row->url?>" target="_blank">点击进入</a></div></td>
		...
		<td><div align="center"><a href="#" onClick="if(really()) no_show2('fri_link_admin.php?delete=yes&select_list=<?=$row->id?>')">删除</a>|<a href="#" onClick="no_show2('fri_link_admin.php?check=yes&select_list=<?=$row->id?>')"><?php if($row->checked=="1") echo "隐藏"; else echo "<font color=red>审批</font>"; ?></a>|<a href="#" onClick="no_show2('fri_link_admin.php?top=yes&select_list=<?=$row->id?>')"><?php if($row->top=="1") echo "已置顶"; else echo "<font color=red>未置顶</font>"; ?></a></div></td>
        </tr>
	   <?php } 
	     }
	   ?>	
  ...
  <tr>
    <td><table border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>&nbsp;</td>
        <td><input name="reply_arc" type="button" class="inputbut" value="置顶" onclick="no_show('fri_link_admin.php','top');"></td>
        <td>&nbsp;</td>
        <td><input name="hide_arc" type="button" class="inputbut" value="审批/隐藏" onclick="no_show('fri_link_admin.php','check');"></td>
        <td>&nbsp;</td>
        <td><input name="delete_arc" type="button" class="inputbut" value="删除" onclick="if(really()) no_show('fri_link_admin.php','delete');"></td>
        <td>&nbsp;</td>
        <td><input name="select_list" type="hidden"></td>
      </tr>
    </table></td>
    <td><a href="fri_link_add.php">加入友情链接</a></td>
  </tr>
</table>
