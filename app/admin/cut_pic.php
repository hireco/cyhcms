                ...
                <TD height=100 colspan="3" bgcolor="#FFFFFF"><div align="center">
                  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><div align="center"><a style="cursor:pointer" href="cut_pic.php?pic_url=<?=$_REQUEST['pic_url']?>&iwidth=<?=$_REQUEST['iwidth']?>&iheight=<?=$_REQUEST['iheight']?>&action=cancel">删除现有缩略图</a></div></td>
                    </tr>
                  </table>
                </div></TD>
              </TR>
...
<form action="<?php if(!isset($_REQUEST['cut_self'])) echo "cut_result.php"; else echo "cutself_result.php"; ?>" name="myform" method="POST">
