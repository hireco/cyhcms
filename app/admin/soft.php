    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="5">
        <tr>
          <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="form1" method="post" action="action/soft_add_action.php" enctype="multipart/form-data" onsubmit="return check_form();">
            ...
            <td width="84" align="center" bgcolor="#FFFFFF">其它参数&nbsp;</td>
                          ...
                          <tr>
                            <td><table width="800" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td width="90">软件标题：                                    </td>
                                  <td width="400"><input name="article_title" type="text" id="article_title" style="width:300px">
                                    加粗
                          ...
                          <tr>
                            <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="90" >上传地址：</td>
                                <td width="400"><input name="rurl" type="text" id="rurl" style="width:300px" value="http://" />
                ...
                <tr>
                  <td width="90" >软件来源：</td>
                  <td width="400"><input name="source_input" type="text" id="source" style="width:300px" /></td>
                  <td width="90">软件级别： </td>
                    ...
                    <?php    
                          ...
                          <tr>
                            <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="90" >演示地址：</td>
                                <td width="400"><input name="official_url2" type="text" id="official_url22" style="width:300px" /></td>
                                <td width="90">文件类型： </td>
                          ...
                          <tr>
                            <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="90" >官方网址：</td>
                                <td width="400"><input name="official_url" type="text" id="official_url" style="width:300px" /></td>
                                <td width="90">软件语言：</td>
                          ...
                          <table width="100%" border="0" cellspacing="2" cellpadding="0" id="adset" style="display:none">
                            <tr>
                              <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="90">访问权限：</td>
                                  <td>                                    <select name="hide_type" id="select7" style="width:160px">
                                      <?php    
									    $conArray = &$hide_type ;
									    foreach ( $conArray as $con_name => $value ) {
	                                    $$con_name = $value  ;
                            ...
                            <tr>
                              <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="90">访问次数：</td>
                                  <td width="320"><input name="read_times" type="text" id="read_times" style="width:100px" value="0" />                                    </td>
                                  <td width="90">是否评论：</td>
                            ...
                            <tr>
                              <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="90">是否置新：</td>
                                  <td><select name="new_or_not" id="select8">
                                    <option value="1" selected="selected">是</option>
                                    <option value="0">否</option>
                                  </select></td>
                                </tr>
