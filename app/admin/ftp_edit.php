    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="5">
        <tr>
          <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="form1" method="post" action="action/ftp_edit_action.php" enctype="multipart/form-data" onsubmit="return check_form();">
      ...
      <td colspan="2" bgcolor="#E2F5BC">
          ...
          <tr> 
            ...
            <td width="84" align="center" bgcolor="#FFFFFF">其它参数&nbsp;</td>
						...
						<table width="100%"  border="0" cellspacing="2" cellpadding="0" id="needset">
                          ...
                          <tr>
                            <td><table width="800" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td width="90">资料标题：                                    </td>
                                  <td width="400"><input name="title" <?php echo $row->title_color==""?"":"style=\"color:".$row->title_color.";\""; ?> type="text" id="title" style="width:300px" value="<?=$row->article_title?>">
                                    加粗
                          ...
                          <tr>
                            <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="90" >资料地址：</td>
                                <td><input name="rurl" type="text" id="rurl" style="width:400px" value="<?=$row->filename?>" />
                ...
                <tr>
                  <td width="90" >资料来源：</td>
                  <td><input name="source_input" type="text" id="source" style="width:160px" value="<?=$row->ftp_from?>" />
                    文件类型：
                    <select name="ftp_format" id="select5">
                       <?php $conArray = &$file_format ;
									    foreach ( $conArray as $con_name => $value ) {
	                                    $$con_name = $value  ;
										echo "<option value='{$con_name}'"; 
										if($con_name==$row->ftp_format) echo " selected";
...
本地</td>
                          ...
                          <tr>
                            <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="90" >转向地址：</td>
                                <td width="400"><input name="jump_url" type="text" id="jump_url2" style="width:300px" value="<?=$row->jump_url?>" />
                                </td>
                                <td width="90">访问权限：</td>
                          ...
                          <tr>
                            <td><table width="800"  border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="90" valign="top">资料介绍：</td>
                                  <td><?php
      ...
      提取第一个图片为缩略图
      <input name="auto_keywords" type="checkbox" id="auto_keywords3" value="1" <?php if($row->keywords=="") echo "checked"; ?> />
      自动获取关键词 </td>
                              </tr>
                            </table></td>
                          </tr>
                          ...
                          <table width="100%" border="0" cellspacing="2" cellpadding="0" id="adset" style="display:none">
                            ...
                            <tr>
                              <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="90">访问次数：</td>
                                  <td width="320"><input name="read_times" type="text" id="read_times" style="width:100px" value="<?=$row->read_times?>"/>                                    </td>
                                  <td width="90">是否评论：</td>
                            ...
                            <tr>
                              <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="90">发布时间：</td>
                                  <td width="320"><input name="post_time" type="text" id="post_time" style="width:100px"  value="<?=$row->post_time?>"/>        </td>
                                  <td width="90">是否锁定：</td>
							...
							<tr>
                              <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="90">相关文章：</td>
                                  <td><textarea name="similar_id" rows="3" id="similar_id" style="width:550px"><?=$row->similar_id?></textarea> <input name="select_article" type="button" id="select_article" value="选择" 
                            ...
                            <tr>
                              <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="90">参考网址：</td>
                                  <td><input name="refer_url" type="text" id="refer_url" style="width:550px" value="<?=$row->refer_url?>" />
                                  </td>
                                </tr>
                              </table></td>
                            </tr>
