...
if(isset($_SESSION['user_name'])){
 if(isset($_POST['pic_url'])){ 
   if($_POST['idkey']==md5(basename($_POST['pic_url']).$_POST['iwidth'].$_POST['iheight'])){
?>
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="600" align="center" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="10">
          ...
          <tr>
            <td><div align="center"><a style="cursor:pointer" href="cut_pic.php?pic_url=<?=$_POST['pic_url']?>&iwidth=<?=$_POST['iwidth']?>&iheight=<?=$_POST['iheight']?>&action=cancel&idkey=<?=$_POST['idkey']?>"><img src="../image/reg_bn11.jpg" width="122" height="22" border="0"></a></div></td>
          </tr>
          <tr>
...
<?php 
imagedestroy($im); 
unset($_POST['width'],$_POST['left'],$_POST['top'],$_POST['photo'],$_POST['scwidth'],$_POST['idkey']);
?> 
</BODY>
</html>
