          ...
          <TD><TABLE height=200 cellSpacing=0 cellPadding=0 width="100%" border=0>
            ...
            width="100%" background=image/tbg.jpg border=0>
                  ...
                  src="image/sp.gif" width=5></TD>
                        ...
                        <TD class=fontg align=middle  width=50><?php if(!isset($_REQUEST['more'])) { ?>
                          <A  href="soft.php?more&class_id=<?=$_REQUEST['class_id']?>"><IMG height=15  src="image/more.gif" width=53  border=0></A>
                          <?php } ?></TD>
                      </TR>
                    </TBODY>
                  </TABLE>
			  ...
			  $query="select * from ".$table_suffix."soft where class_id=$class_id order by top desc, top_time desc"; 
			  ...
			  ?>
                            ...
                            <TBODY>
                              <TR class=downquerytitle height=25>
                                <TD colspan="3"><IMG 
                        src="image/items.gif" width=16 height=14 align="absmiddle"> 软件名称<A class=tList 
                        href="show_soft.php?id=<?=$row->id?>" 
                        target=_blank>
                                  <font color="<?=$row->title_color?>"><?=$row->article_title?></font>
                                </A>[大小:<?php 
                        ...
                        class=fonts>
                              ...
                              <TR>
                                <TD height="19" colspan="3" align=middle><div align="left">
                                  &nbsp;&nbsp;&nbsp;
                                  <?=$row->abstract?></div>                                  </TD>
                              </TR>
                              <TR><TD background=image/line.gif 
                      height=3></TD>
                              </TR>
                            </TBODY>
                          </TABLE>
			   ...
			   $query="select * from ".$table_suffix."soft where class_id=$class_id order by top desc, top_time desc limit 0, 8";
			   $result=mysql_query($query);
		   ...
		   $query="select * from ".$table_suffix."infor where upper_class_id=$class_id";
            ...
            width=50>                          <A  href="soft.php?more&class_id=<?=$soft_class_id?>"><IMG height=15  src="image/more.gif" width=53  border=0></A>                          </TD>
                      </TR>
                    </TBODY>
                  </TABLE>
              ...
              border=0>
                    <TBODY>
                      <TR>
                        <TD vAlign=top>
                          <?php 
				     $query="select * from ".$table_suffix."soft where class_id=$soft_class_id order by top desc, top_time desc limit 0, 8";
				 ...
				 if((!$num_of_soft)&&(!$num_of_sub_class)) echo "本栏目没有发布对象";
			   }
			   ?></TD>
              </TR>
            </TBODY>
