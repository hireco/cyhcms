...
<?php 
	...
	elseif(isset($_SESSION['user_name'])) { 
	  if($host_name==$_SESSION['user_name'])   { ShowMsg("对不起,不能传纸条给自己","-1"); echo "<br>";  exit; }
	...
	if(in_array($_SESSION['user_id'],$black_list))  { ShowMsg("抱歉,对方已经屏蔽了您的纸条",-1); echo "<br>";  exit;}
	
	if(empty($content))   { ShowMsg("对不起,您的纸条内容丢失或为空白","-1");  echo "<br>";   exit; 	 }
	...
	(infor_title, content,to_user_name,person, from_user_name,post_time,post_ip,hide,whisper) 
	 values 
	('$infor_title','$content','$to_user_name','$person','$from_user_name','$post_time','$post_ip','$hide','1')";
    
	$result=mysql_query($query);
    if($result)  { ShowMsg("恭喜您,您的纸条已经提交","-1");  echo "<br>";  exit; }
  } 
  else {
?>
            ...
            <form  name="form" action="" method=post enctype=multipart/form-data>
              <tbody>
                <tr>
                  ...
                  <td height=25 nowrap class=bbscon><?php if(isset($_SESSION['user_name'])&&isset($_SESSION['nick_name']))  { ?>
                    ...
                    您还没有登录,不可以进行此操作 <a href="member.php?to_go=<?php  
				  ...
				  if(ereg("IIS",$_SERVER['SERVER_SOFTWARE']))  echo urlencode($_SERVER['HTTP_X_REWRITE_URL']);
	              else if(ereg("Apache",$_SERVER['SERVER_SOFTWARE'])) echo urlencode($_SERVER['REQUEST_URI']);?>" style="text-decoration:underline"> 注 册</a>
                    <?php } ?>
				  </td>
                </tr>
				...
				<tr>
				  ...
				  <td height=25 class=bbscon><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="80">纸条标题</td>
				...
				<tr>
                  ...
                  <td height=25 class=bbscon><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="80" valign="top">纸条内容</td>
                ...
                <tr>
                  <td  align=middle height=25></td>
                  <td height=25 nowrap class=bbscon><div align="left">
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td class=bbscon><input name="submit_liuyan" type=submit class=button id="submit_comment" value="传纸条给博主" onclick="return check_form_zhitiao();"></td>
                      </tr>
                    </table>
                  </div></td>
                </tr>
