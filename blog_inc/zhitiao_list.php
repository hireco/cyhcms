...
<?php  if($_SESSION['user_name']<>$host_name) require_once(dirname(__FILE__)."/add_zhitiao.php"); ?>
...
<TABLE height=30 cellSpacing=0 cellPadding=0 width="100%" 
  ...
  <TBODY>
    <TR>
      ...
      <TD><strong>所有纸条</strong></TD>
      <TD><div align="center"><a href="#say" style="text-decoration:underline ">发布纸条</a></div></TD>
    </TR>
  </TBODY>
</TABLE>
<?php 
  $query_liuyan="select * from ".$table_suffix."member_guestbook where whisper='1' and to_user_name='$host_name' order by post_time desc";
