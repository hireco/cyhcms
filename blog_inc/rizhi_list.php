...
<table width="100%"  border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td bgcolor="#EEF7F3"><strong>日志列表</strong></td>
  </tr>
  <tr>
  ...
  <tr>
          ...
          <td>
	        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>
				<?php  
				$result_row=mysql_query("select distinct folder_name from ".$table_suffix."member_blog where user_name='$host_name' and blog_class='rizhi'");
				...
				选择分类：<select name="folder_name" class="INPUT" onchange="location=this.value;">
					...
					echo "<option ";
					echo "value=\"user_infor.php?view=rizhi&view_class=".urlencode($folder_row->folder_name)."&host_id=".$host_id."&idkey=".$_REQUEST['idkey']."\"";
	...
	<?php  
	if(isset($_REQUEST['view_class'])) $query="select * from ".$table_suffix."member_blog where blog_class='rizhi' and folder_name='{$_REQUEST['view_class']}' and user_name='$host_name'";  
	else $query="select * from ".$table_suffix."member_blog where blog_class='rizhi' and user_name='$host_name'";  
	...
	?>
    <tr>
        <td><div align="left" class="fonts"><a href="user_infor.php?view=rizhi&infor_id=<?=$row->id?>&idkey=<?=$_REQUEST['idkey']?>" style="color:#3366CC; text-decoration:underline">
