...
<?php require_once(dirname(__FILE__)."/../config/auto_set.php");?>
<?php 
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div style="BORDER-RIGHT: #8bd 1px solid; BORDER-TOP: #8bd 1px solid; BACKGROUND: #ebf3fa; OVERFLOW: hidden; BORDER-LEFT: #8bd 1px solid; WIDTH: 100%; LINE-HEIGHT: 23px; BORDER-BOTTOM: #8bd 1px solid; HEIGHT: 25px;">
...
<?php $scroll_i=0; 
   ...
   $abstract="...->[详情]";
   echo "scroll_content[".$scroll_i."]=\"<TABLE cellSpacing=0 cellPadding=3 width=100% border=0><TBODY><TR><TD valign=top><a href='show_".$row->infor_class.".php?id=".$row->infor_id."' target='_blank'><font color='#FF0000'><span style='font-size:9pt;line-height: 15pt'><b>【".$row->article_title."】</b></font></a><a href='show_".$row->infor_class.".php?id=".$row->infor_id."' target='_blank'>".$abstract."</a></TD></TR></TBODY></TABLE>\";";
   $scroll_i++;  
} 
?>
startscroll();
