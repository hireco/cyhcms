...
$_SESSION['small_photo']=$imgname;

$result=copy($temp_photo,$imgname);
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="600" align="center" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="10">
          ...
          <tr>
            <td><div align="center"><?php echo "<img src=\"$imgname\" >"; ?></div></td>
          </tr>
          <tr>
            <td><div align="center"><a style="cursor:pointer" href="cut_pic.php?pic_url=<?=$_POST['pic_url']?>&iwidth=<?=$_POST['iwidth']?>&iheight=<?=$_POST['iheight']?>&action=cancel&cut_self"><img src="image/reg_bn11.jpg" width="122" height="22" border="0"></a></div></td>
          </tr>
          <tr>
