...
if(!isset($_POST['submit_class']))  { echo "<script>alert(\"Sorry! 访问出错!\"); location.replace(\"infor.php?infor_class=article\"); </script>"; exit;} 
//head files
...
(class_name,class_level,upper_class_id,top,
 ...
 picture_title,top_navi,
 left_navi,index_block,class_attribute,creator,create_time,introduction,keywords,post_type,hide_type,infor_class,template)
 values 
 ('$class_name','$class_level',$upper_class_id,'$top',
 '$top_time','$picture','$picture_link',
 '$picture_title','$top_navi',
...
echo "<script>alert(\"恭喜您! 成功建立文章栏目!\"); location.replace(\"infor.php?infor_class=$infor_class\");</script>";   
?>
