...
function MakeUpload(mnum)
{
   ...
   for(startNum;startNum < endNum;startNum++)
   {
	   ...
	   fhtml = "";
	   fhtml += "<table width='800'><tr><td><input type='checkbox' name='isokcheck"+startNum+"' id='isokcheck"+startNum+"' value='1'   "+dsel+" onClick='CheckSelTable("+startNum+")' />显示图片["+startNum+"]的选取框</td></tr></table>";
	   ...
	   fhtml += "<td width=\"370\" rowspan=\"5\" align=\"center\"><img src=\"image/picview.jpg\" width=\"150\" id=\"picview"+startNum+"\" name=\"picview"+startNum+"\"></td>";
	   fhtml += "</tr>";
	   fhtml += "<tr bgcolor=\"#FFFFFF\"> ";
