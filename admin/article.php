    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="5">
        <tr>
          <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="form1" method="post" action="action/article_add_action.php" enctype="multipart/form-data" onsubmit="return check_form();">
            ...
            <td width="84" align="center" bgcolor="#FFFFFF">其它参数&nbsp;</td>
                ...
                <tr>
                   ...
                   <td width="400"><input name="source_input" type="text" id="source" style="width:160px" value="<?=$cfg_site_name?>"/>
                      <input name="selsource" type="button" id="selsource" value="选择" onClick="OpenMywin('source_writer.php?action_do=selsource')">
				   </td>
                  <td width="90" >文章编辑：</td>
