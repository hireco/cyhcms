    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="5">
        <tr>
          <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="form1" method="post" action="action/album_add_action.php" enctype="multipart/form-data" onsubmit="return check_form();">
      ...
      <td colspan="2" bgcolor="#E2F5BC">
          ...
          <tr> 
            ...
            <td width="84" align="center" bgcolor="#FFFFFF">其它参数&nbsp;</td>
                ...
                <tr>
                  <td width="90" >文章来源：</td>
                  <td width="400"><input name="source_input" type="text" id="source" style="width:160px" value="<?=$cfg_site_name?>"/>
                      <input name="selsource" type="button" id="selsource" value="选择" onClick="OpenMywin('source_writer.php?action_do=selsource')"></td>
                  <td width="90" >文章编辑：</td>
                  <td ><input name="writer_input" type="text" id="writer" style="width:160px"  value="<?=$_SESSION['writer_name']?>"/>
...
本地 </td>
                          ...
                          <tr>
                            <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="90">&nbsp;表现方式：</td>
                                <td>
                                  <input name="show_style" id='pagestyle1' type="radio" onclick="HideObj('showstyle1')"  value="1"  />
      幻灯显示
      <input name="show_style" type="radio"   id='pagestyle2' onclick="ShowObj('showstyle1')" value="2" checked="checked" />
      多行多列 
      ...
      加水印</td>
                              ...
                              <table width="800" border="0" cellpadding="0" cellspacing="0" id="showstyle1">
                                <tr>
                                  <td width="90">&nbsp;格式参数：</td>
                                  <td><input name="hang" type="text" id="hang" style="width:30px" value="4" />                                    
                                    行                                    <input name="lie" type="text" id="lie" style="width:30px" value="4" />
                                    列 小图片宽度限制
                                    <input name="small_width" type="text" id="small_width" style="width:30px" value="150" />
                                    像素</td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr>
                            <td><table width="800" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="90">&nbsp;大图宽度：</td>
                                <td> <input name="big_width" type="text" style="width:30px" value="800"/>
                                  像素(防止图片太宽在模板页中溢出) </td>
                              </tr>
                            </table></td>
                          </tr>
                            ...
                            <tr>
                              <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="320"><input name="short_title" type="text" id="short_title" style="width:300px" value="" />                  </td>
                                  <td width="90">定义属性：                                    </td>
                            ...
                            <tr>
                              <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="320"><input name="vice_title" type="text" id="vice_title" style="width:300px" value="" />                                  </td>
                                  <td width="90">访问权限： </td>
          ...
          <option value="0">否</option>
                            ...
                            <tr>
                              <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="90">相关文章：</td>
                                  <td><textarea name="similar_id" rows="3" id="similar_id" style="width:550px"></textarea> <input name="select_article" type="button" id="select_article" value="选择" 
