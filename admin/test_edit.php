        ...
        <tr>
          <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>
			  <?php 
			  if($rows->locked=="1")  MsgClose1("该对象被锁定，请先解锁！");
			  else { ?>
			  <form name="form_q" method="post" action="action/test_edit_action.php"  onsubmit="return check_form();">
                <table width="100%" border="0" cellpadding="2" cellspacing="0">
                  ...
                  <tr>
                        ...
                        <td valign="top"><table width="100%"  border="0" cellspacing="5" cellpadding="0" id="needset">
                          ...
                          <tr>
                            <td><table border="0" cellpadding="0" cellspacing="5">
								...
								?>
                                      <option value="<?=$row->part_name?>" <?php if($rows->part==$row->part_name) echo "selected";?>>
                                      <?=$row->part_name?>
                                      </option>
                                      <?php } ?>
                                  </select></td>
                                ...
                                <tr>
                                  ...
                                  <td><select name="degree" id="select49" style="width:80px; ">
                                    <?php    
										...
										if($rows->degree==$$con_name) echo "selected";
                          ...
                          <tr>
                            <td><table border="0" cellpadding="0" cellspacing="5">
                              <tr>
								...
								<?php    
								  $chapter_default=$rows->chapter; 
								  $section_default=$rows->section;    
								  $point_default=$rows->point;
					...
					$fck->Value = $rows->problem_content ;
					$fck->Create(); ?> <input name="id" type="hidden" id="id" value="<?=$_REQUEST['id']?>" /></td>
                              </tr>
                            </table></td>
                            </tr>
                        </table></td>
