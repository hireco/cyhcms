...
<br>
 <?php 
    ...
    echo $part_name." > ".$chapter_name." > 修改小节";
	...
	if(isset($_POST['submit_section'])) {
	 ...
	 $query="update ".$table_suffix."section set section_name ='$section_name', outline='$outline', point='$point', difficulty='$difficulty', 
	          importance='$importance',last_editor='$last_editor', last_time='$last_time' where id=$id";
	 $result=mysql_query($query);
	 if($result) ShowMsg("成功的更新小节","section_admin.php?chapter_id=".$chapter_id);
	 else ShowMsg("更新小节失败，可能有重名，请重来！",-1);
    } 
    else { 
?>
<table width="100%" border="0" cellpadding="5">
  <tr>
    ...
    <td width="20">&nbsp;</td>
    <td><input name="chapter_name" type="text" class="INPUT" id="chapter_name" style="width:500px;" value="<?=$row->section_name?>"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><label>
        <textarea name="point" rows="3" class="TEXTAREA" id="point" style="width:500px;"><?=$row->point?></textarea>
      </label></td>
    </tr>
    <tr>
      <td valign="top"><div align="right">本节重点</div></td>
      <td>&nbsp;</td>
      <td><textarea name="importance" rows="3" class="TEXTAREA" id="importance" style="width:500px;"><?=$row->importance?></textarea></td>
    </tr>
    <tr>
      <td valign="top"><div align="right">本节难点</div></td>
      <td>&nbsp;</td>
      <td><textarea name="difficulty" rows="3" class="TEXTAREA" id="difficulty" style="width:500px;"><?=$row->difficulty?></textarea></td>
    </tr>
    <tr>
