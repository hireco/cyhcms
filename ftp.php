        ...
        <TR vAlign=top>
          <TD>
            <TABLE height=200 cellSpacing=0 cellPadding=0 width="100%" border=0>
			  ...
			  $query="select * from ".$table_suffix."ftp where class_id=$class_id order by top desc, top_time desc";
			  ...
			  for($i=1;$i<=$per_page_num;$i++)
				{ if($row=@mysql_fetch_object($rows)){ ?>
			      <TR>
                        ...
                        href="show_ftp.php?id=<?=$row->id?>"><?=msubstr($row->article_title,0,60)?></A></div></TD>
                                  <TD height=19><?php 
			 ...
			 <?php 
			  ...
			  if($num_of_ftp) 
			   {			 
			 ?>
             <TABLE class=table height=26 cellSpacing=0 cellPadding=0  width="100%" background=image/tbg.jpg border=0>
                <TBODY>
                  <TR>
                  ...
                  src="image/sp.gif" width=5></TD>
                    ...
                    <TD class=fontg align=middle  width=50><?php if(!isset($_REQUEST['more'])) { ?>
                        <A  href="ftp.php?more&class_id=<?=$_REQUEST['class_id']?>"><IMG height=15  src="image/more.gif" width=53  border=0></A>
                        <?php } ?></TD>
                  </TR>
                </TBODY>
              </TABLE>
            ...
            width=50>                            <A  href="ftp.php?more&class_id=<?=$ftp_class_id?>"><IMG height=15  src="image/more.gif" width=53  border=0></A>                            </TD>
                        </TR>
                      </TBODY>
                    </TABLE>
              ...
              border=0>
			         ...
			         ?> <table width="100%"  border="0" cellspacing="0" cellpadding="3">
                              ...
                              <TBODY>
                               ...
                               <TD width="15%">点击次数</TD>
                                ...
                                <TR>
                                  <TD align=middle><div align="left"><IMG 
                        src="image/items.gif" width=16 height=14 align="absmiddle"><A class=tList 
                        href="show_ftp.php?id=<?=$row_sub->id?>" 
                        target=_self>
                                      <?=msubstr($row_sub->article_title,0,60)?>
                                  </A></div></TD>
                        ...
                        class=fonts>
                                    <?php 
								  $filesize=filesize(ereg_replace($cfg_mainsite,"",$row_sub->filename))/1024.0;
								  if(empty($filesize)) echo "不详";
								  else { 
								  $filesize=explode(".",$filesize);
								  if($filesize[1]=="") $filesize[1]="0";
                        ...
                        class=fonts>
								...
								<TD><?=$row_sub->read_times?></TD>
                                </TR>
                                <TR><TD background=image/line.gif colSpan=2  height=3></TD>
                                </TR>
                                  <?php } ?>
                              </TBODY>
                            </TABLE>
